...
class ntc {
  ...
  name(color) {
    ...
    for (var i = 0; i < scope.names.length; i++) {
      if (color == "#" + scope.names[i][0])
        return ["#" + scope.names[i][0], scope.names[i][1], true];

      ndf = scope.deltaEHex(color, scope.names[i][0]);
    ...
    return (cl < 0 ? ["#000000", "Invalid Color: " + color, false] : ["#" + scope.names[cl][0], scope.names[cl][1], false]);
  }
